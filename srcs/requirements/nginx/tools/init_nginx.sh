...
echo "SecAction \"id:900000, phase:1, pass, t:none, nolog, tag:'OWASP_CRS', ver:'OWASP_CRS/4.15.0-dev', setvar:tx.blocking_paranoia_level=2\"" >> /usr/local/coreruleset/crs-setup.conf
